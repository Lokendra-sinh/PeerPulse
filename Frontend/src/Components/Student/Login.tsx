  ...
  return (
    ...
    <div className="mx-auto px-4 grid max-w-5xl items-center space-y-6 lg:gap-10">
      <div className="space-y-2 text-center">
        ...
        <p className="max-w-[600px] font-normal mx-auto text-gray-700 dark:text-gray-400">
        Sign in now and unleash the power of personalized tutoring sessions tailored to your needs and goals.
        </p>
      </div>
      <div className="rounded-lg border bg-bgYellow1 text-card-foreground shadow-sm" data-v0-t="card">
        <div className="space-y-1.5 p-6 flex flex-col gap-1">
          <h3 className="whitespace-nowrap tracking-tight text-2xl font-bold text-textBlue">Student</h3>
          <p className="text-sm text-muted-foreground text-textBlue">Login as a student and connect with a community eager to lift you higher</p>
        </div>
